...
class BrandedToken {
  ...
  liftRestrictionRawTx(addresses) {
    ...
    return Promise.resolve(this.contract.method.liftRestriction(addresses));
  }
  ...
  isUnrestricted(address) {
    return this.contract.methods
      .convertToBrandedTokens(address)
      .call();
  }
}
