...
class GCHelper {
  ...
  setup(config, txOptions, originWeb3) {
    ...
    // Deploy the Contract
    const promiseChain = oThis.deploy(owner, valueToken, brandedToken, deployParams, originWeb3);
  ...
  deploy(owner, valueToken, brandedToken, txOptions, originWeb3) {
    ...
    const tx = oThis._deployRawTx(owner, valueToken, brandedToken, txOptions, originWeb3);
