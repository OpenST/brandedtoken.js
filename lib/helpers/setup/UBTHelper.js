...
class UBTHelper {
  ...
  deploy(_token, _symbol, _name, _decimals, _organization, txOptions, auxiliaryWeb3) {
    ...
    const tx = oThis._deployRawTx(_token, _symbol, _name, _decimals, _organization, txOptions, auxiliaryWeb3);
  ...
  setCoGateway(cogateway, txOptions, contractAddress, auxiliaryWeb3) {
    ...
    const tx = oThis._setCoGatewayRawTx(cogateway, txOptions, contractAddress, auxiliaryWeb3);
