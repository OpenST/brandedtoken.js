...
class StakeHelper {
   ...
   * @param signature EIP712 Signature object of KYC worker address generated by signing StakeRequest typed-data.
   *                  {
   ...
   */
  _acceptStakeRequestRawTx(stakeRequestHash, signature, facilitator, hashLock, originWeb3, txOptions) {
    const oThis = this;
