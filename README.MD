...
// You will need to have worker private key for signing.
const workerPrivateKey = '0xaabb1122....................';
const workerAccount = oThis.web3Object.eth.accounts.decrypt(workerPrivateKey, passphrase);
